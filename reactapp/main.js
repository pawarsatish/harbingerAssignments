...
// import MainReduxComponent from "./reduxapp/maincomponent.jsx";
 ...
 let Component = HoC(CompanyListComponent, cList);
 let IComponent = HoC(ItemListComponent, iList);
...
//ReactDom.render(<Provider store={store}><MainReduxComponent /></Provider>,document.getElementById("app"));
